...
# PRACTICUM_TOKEN = 'y0_AgAAAAA0IsOHAAYckQAAAADaXmfm1JO9-yHzQq6mdGt9a0i8etMz3d4'
# TELEGRAM_TOKEN = '5685856696:AAHIXUDSwaswll-TGIKremLklFhMGTN1auo'
# TELEGRAM_CHAT_ID = 505225409
...
def get_api_answer(timestamp):
    ...
    if response.status_code != HTTPStatus.OK:
        logger.error(
            'Ошибка. Эндпоинт {ENDPOINT} недоступен. '
